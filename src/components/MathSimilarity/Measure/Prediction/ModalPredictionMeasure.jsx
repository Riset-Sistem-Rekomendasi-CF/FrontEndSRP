...
const ModalPredictionMeasure = ({ dataRating, opsional, similarity, topSimilarities, selectedValue, selectedIndex, data, result, kValue, close }) => {
    ...
    return (
        <div
            ...
            <div
                ...
                <h2 className="text-xl font-semibold mb-4">Detail Perhitungan Prediksi</h2>
                ...
                <div className="overflow-x-auto mt-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <h2 className='font-semibold text-lg'>Matrik <span
