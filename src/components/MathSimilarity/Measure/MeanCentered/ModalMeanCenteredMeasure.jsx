...
const ModalMeanCenteredMeasure = ({ similarity, selectedIndex, selectedValue, dataOnly, result, opsional, close }) => {
    ...
    return (
        <div
            ...
            <div
                className="bg-white p-6 rounded-lg shadow-lg w-full max-w-4xl sm:max-w-md md:max-w-lg lg:max-w-xl overflow-y-auto max-h-[80%] m-6">
                <h1 className='text-lg sm:text-xl md:text-2xl font-semibold mb-4'>
                    Detail Menghitung <span className='italic'>Mean-Centered</span> untuk setiap
                    Data rating yang diketahui
                </h1>
