...
export function ScatterPlotData({ opsional, result }) {
  ...
  const dataPlotVisual = similarityData.map((item) => item); // Mengambil elemen-elemen dalam similarityData
  // console.log("ini data plot visual", dataPlotVisual);
  const ScatterPlot = () => {
    ...
    return (
      <div className="mt-6 text-justify max-w-full md:max-w-xl mx-auto px-4">
        ...
        <p className={`text-sm mb-2}`}>
          ...
          dimensi lebih rendah (misalnya 2D atau 3D) sambil mempertahankan jarak
