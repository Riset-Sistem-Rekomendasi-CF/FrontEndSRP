...
import {
    BackToTopButtonHome,
} from "../../components/Navigate/BackToTopNavigate";
            ...
            description: (
                <>
                    ...
                    <p className="ml-5 mb-4">
                        Nilai 1 menunjukkan hubungan positif sempurna, artinya dua user atau
                        item memiliki pola rating yang sangat mirip. Misalnya, jika user A
                        memberi rating tinggi pada suatu item, user B cenderung memberi
                        rating tinggi juga pada item yang sama.
                    </p>
                    <p className="ml-5 mb-4">
                        Nilai -1 menunjukkan hubungan negatif sempurna, di mana kedua user
                        atau item memiliki pola rating yang bertentangan. Contohnya, jika
                        user A tidak menyukai suatu item, user C mungkin justru menyukai
                        item tersebut.
                    </p>
                    <p className="ml-5 mb-4">
                        Nilai 0 berarti tidak ada hubungan linier antara dua user atau item.
                        Perubahan rating user A tidak mempengaruhi rating user D, sehingga
                        rekomendasi berdasarkan pola rating mereka tidak efektif.
                    </p>
                </>
            ),
        },
        {
            ...
            description: (
                <>
                    ...
                    membandingkan kesamaan antara preferensi pengguna atau kesamaan antara
                    item. Nilai yang mendekati 1 menunjukkan korelasi yang kuat antara
                    kedua variabel, sementara nilai yang mendekati 0 menunjukkan tidak
                    adanya korelasi, yang berarti kedua variabel bersifat independen.
                </>
            ),
        },
        {
            ...
            description: (
                <>
                    <p className="mb-4">
                        ...
                        kinerja dari BC tergantung pada pola distribusi rating.
                    </p>
                    <p className="mb-4">
                        Nilai Similaritas BC berkisar antara 0 hingga 1, dan bersifat
                        simetris
                    </p>
                </>
            ),
